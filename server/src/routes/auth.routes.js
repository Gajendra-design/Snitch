...
import { authenticateMiddleware, loginMiddleWare, refreshMiddleware, registerMiddleware } from '../middleware/auth.middleware.js';
...
router.get('/verifyUser',authenticateMiddleware,verifyUserController)
